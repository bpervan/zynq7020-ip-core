...
HD_PWD='d:/projects/coolcracker/vivado/ip_repo/edit_Bcrypt_v4_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcrypt.tcl
